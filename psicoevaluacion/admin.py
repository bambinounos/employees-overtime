...
class ResultadoFinalAdmin(admin.ModelAdmin):
    ...
    readonly_fields = (
        ...
        'puntaje_atencion_detalle', 'puntaje_atencion_comparacion',
        'puntaje_atencion_verificacion', 'puntaje_atencion_secuencias',
        'puntaje_memoria_visual', 'puntaje_mv_precision', 'puntaje_mv_honestidad',
        'puntaje_arbol', 'puntaje_persona_lluvia', 'puntaje_frases',
        'puntaje_frases_trabajo', 'puntaje_frases_autoridad',
        'puntaje_frases_compromiso', 'puntaje_colores',
        'detalle_arbol', 'detalle_persona_lluvia', 'detalle_colores',
